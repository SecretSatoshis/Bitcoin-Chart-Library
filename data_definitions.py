...
filter_data_columns = {
    'Report_Metrics': [
        ...
        '365_day_ma_TxTfrValAdjUSD', 'RevUSD', 'AdrActCnt', '7_day_ma_priceUSD',
        ...
        '30_day_ma_IssContNtv','30_day_ma_TxCnt','30_day_ma_HashRate',
        '30_day_ma_TxTfrValAdjUSD', '30_day_ma_RevUSD','365_day_ma_RevUSD','30_day_ma_TxTfrValMeanUSD',
        '30_day_ma_TxTfrValMedUSD','AdrBalUSD1MCnt','AdrBalUSD10MCnt',
        'AdrBalUSD10KCnt','AdrBalUSD1KCnt','AdrBalUSD10Cnt', 'AdrBalUSD1Cnt', 
        'AdrBalCnt', 'SplyAct1d', 'SplyAct30d','SplyAct90d', 'SplyAct180d', 'SplyAct1yr', 'SplyAct3yr', 'SplyAct4yr',
        'SplyAct2yr', 'SplyAct5yr', 'SplyAct10yr', 'SplyFF', 'CapMVRVCur', 'liquid_supply', 'illiquid_supply',
        'SplyMiner0HopAllNtv','SplyMiner1HopAllNtv', 'TxTfrValAdjNtv',
        'United_Kingdom_btc_price','United_Kingdom_cap','United_States_btc_price','United_States_cap',
        'Global_Fiat_Supply_btc_price', 'SF_Predicted_Price', 'SF_Multiple', 'China_btc_price', 'Eurozone_btc_price',
        'Japan_btc_price', 'Switzerland_btc_price', 'India_btc_price', 'Australia_btc_price',
        'Russia_btc_price', 'MSFT_mc_btc_price', 'GOOGL_mc_btc_price', 'NVDA_mc_btc_price', 'AMZN_mc_btc_price',
        'V_mc_btc_price', 'TSLA_mc_btc_price', 'JPM_mc_btc_price', 'PYPL_mc_btc_price', 'GS_mc_btc_price', 'META_mc_btc_price',
